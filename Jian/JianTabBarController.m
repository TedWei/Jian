...
#import "UIViewController+JianTabBarControllerViewController.h"
...
@interface JianTabBarController ()
{
...
@implementation JianTabBarController
{
    // Bottom tab bar view
    JianTabBar *tabBar;
    
    // Content view
    JianTabBarView *tabBarView;
...
- (void)loadView
{
    ...
    tabBarView = [[JianTabBarView alloc] initWithFrame:[[UIScreen mainScreen] applicationFrame]];
    ...
    tabBar = [[JianTabBar alloc] initWithFrame:tabBarRect];
...
- (void)loadTabs
{
    ...
    for (UIViewController *vc in self.viewControllers)
    {
        ...
        JianTab *tab = [[JianTab alloc] init];
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)interfaceOrientation duration:(NSTimeInterval)duration
{
    ...
    for (JianTab *tab in [tabBar tabs])
        [tab setNeedsDisplay];
